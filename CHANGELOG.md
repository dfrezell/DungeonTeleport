...
### Fixed
- v1.3.2 release package was missing the 12.0.7 interface support; re-released with the fix included

## [1.3.2] - 2026-06-18

### Changed
- Added WoW 12.0.7 interface version support

## [1.3.1] - 2026-04-21

### Changed
- Added WoW 12.0.5 interface version support

## [1.3.0] - 2026-02-08

### Added
- `/dt taco` command to toggle the Taco Panda animation preview window
- Animated Taco Panda preview window (movable, closable) using a sprite sheet
- Taco Panda sprite sheet asset

### Changed
- Updated localization strings and help text to include the taco command
- Updated addon documentation to mention the taco command
...
[1.3.3]: https://github.com/dfrezell/DungeonTeleport/releases/tag/v1.3.3
[1.3.2]: https://github.com/dfrezell/DungeonTeleport/releases/tag/v1.3.2
[1.3.1]: https://github.com/dfrezell/DungeonTeleport/releases/tag/v1.3.1
[1.3.0]: https://github.com/dfrezell/DungeonTeleport/releases/tag/v1.3.0
